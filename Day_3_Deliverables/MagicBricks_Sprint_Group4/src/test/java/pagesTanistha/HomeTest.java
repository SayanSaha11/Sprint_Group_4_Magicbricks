 ...
 * 
 * homePage.getBuy().click(); System.out.println("Clicked Buy tab");
 * 
 * // Click Budget homePage.getBudget().click();
 * System.out.println("Clicked Budget option");
 * 
 * // Select Min Budget (₹10 Lac) homePage.selectMinBudget();
 * System.out.println("Selected Min Budget");
 * 
 * // Select Max BHK (8 BHK) homePage.selectMaxBudgetOption();
 * System.out.println("Selected Max BHK");
 * 
 * // Click Search homePage.getSearchButton().click();
