...
public class BuyStep {
	...
	private void init() {
	 ...
	 @Given("I click on the {string} heading")
	    ...
	    public void i_click_on_link(String string) {
	        ...
	        Common.parentWindow = driver.getWindowHandle();  // ⭐ SAVE HERE
	...
	public void i_switch_to_the_new_agent_listing_tab() {
		...
		for (String w : windows) { 
			if(!w.equals(Common.parentWindow)) { 
	...
	public void i_switch_to_the_agent_detail_tab() {
		Set<String> windows = driver.getWindowHandles();
	    for (String w : windows) {
	        if (!w.equals(Common.parentWindow) && !w.equals(agentListingWindow)) {
	            driver.switchTo().window(w);
	            break;
	        }
	    }
	...
	public void i_click_on_the_budget_filter_option() {
		init();
	    home.getBudget().click();  // Simple click, just like Budget_Step
	}
	...
	public void i_click_the_search_button() {
		...
		Common.parentWindow=driver.getWindowHandle(); 
