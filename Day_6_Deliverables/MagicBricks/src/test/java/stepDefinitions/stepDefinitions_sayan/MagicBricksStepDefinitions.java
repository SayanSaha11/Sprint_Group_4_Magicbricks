package stepDefinitions.stepDefinitions_sayan;

import pages.pages_sayan.BasePage;
import pages.pages_sayan.BudgetHomesPage;
import pages.pages_sayan.CommercialSpacePage;
import pages.pages_sayan.HomePage;
import pages.pages_sayan.HouseForSalePage;
import pages.pages_sayan.NewProjectsPage;
import pages.pages_sayan.OfficeSpacePage;
import pages.pages_sayan.PlotPage;
import pages.pages_sayan.PremiumHomesPage;
...
import utils.utils_sayan.ExcelUtils;
...
public class MagicBricksStepDefinitions {
    ...
    public void the_map_should_be_displayed_with_the_property_marked() {
        WebElement canvas = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//div[@class='loc-det__banner__ctablock']")));
